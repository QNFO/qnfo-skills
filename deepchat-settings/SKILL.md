...
- `language`: DeepChat locale, including `system`, `zh-CN`, `en-US`, `zh-TW`, `zh-HK`, `ko-KR`, `ru-RU`, `ja-JP`, `fr-FR`, `fa-IR`, `pt-BR`, `da-DK`, `he-IL`, `es-ES`, `de-DE`, `tr-TR`, `id-ID`, `ms-MY`, `it-IT`, `pl-PL`, `vi-VN`.
...
- `section` hints: `common`, `display`, `appearance`, `theme`, `language`, `font`, `font-size`, `sound`, `copy`, `copy-cot`, `proxy`, `provider`, `mcp`, `prompt`, `prompts`, `providers`, `acp`, `skills`, `knowledge-base`, `database`, `shortcut`, `about`.
