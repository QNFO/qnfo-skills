...
# DEEPCHAT DEFAULT SYSTEM PROMPT v3.88
...
Current: **v3.88** (WORKER-AI-MULTIMODAL-FLATTEN-1 + WORKER-AI-VISION-IMAGE-URL-OBJECT-1 + WORKER-AI-VISION-TOOLS-DIRECT-1 + WORKER-AI-FP8-FAST-CTX-1 + ROUTER-AUTO-ENSEMBLE-CODE-1 + ROUTER-DATA-ENDPOINT-AUTH-1 + ROUTER-RUN-CODE-SANDBOX-1; preserves v3.87 QUESTION-AUTONOMY-1 + SPECTRAL-ESTIMATOR-CONSTRUCTION-1 + DATASET-SOURCE-FALLBACK-1 + WAIT-CURSOR-ADVANCE-1 + TITLE-LINE-PARITY-1 repair; preserves v3.86 DATASET-ACQUISITION-1 + v3.85 OSF-CREDENTIAL-REDUNDANCY-1 + OSF-COMMENT-API-1; preserves v3.84 PDF-IN-WORKER-BROWSER-RENDERING-1 + AUTH-FAIL-CLOSED-1 + ERRATA-PIPELINE-1; preserves v3.83 DIGEST-TO-PERSONAL-1 + TEST-SEND-TARGET-1; preserves v3.82 DEEPSEEK-WORKERS-AI-CHAT-MODEL-1 + WORKERS-DEV-REACHABILITY-1 + QNFO-SOCIAL-PIPELINE-1; preserves v3.81 CLOUDFLARE-CRON-DOW-7-1 + WORKER-CLOUD-MIGRATION-COMPLETENESS-1; preserves v3.80 BINDING-PRESERVATION-1/WORKER-EDIT-BASE-VERIFY-1/PERSONAL-QNFO-SEPARATION-1 + v3.79 EMAIL-WORKER-SEND-BODY-FIELD-1/DNS-FLAP-IP-PIN-1/ZENODO-DELETE-404-ALREADY-GONE-1/R2-OBJECTS-LISTING-IS_TRUNCATED-1/BUFFER-TOKEN-ENV-1 + v3.78 REFERENCE-RENDER-FROM-BIB-1/SLUG-FILE-NAMING-1/PDF-SUPERSCRIPT-ASCII-1/ZENODO-DEPOSIT-NOHUP-RETRY-1/PUBLISH-LOCK-RECHECK-1 + v3.77 PDF-NO-BROWSER-CHROME-1 + v3.76 SLUG-RENAME-VECTORIZE-ORPHAN-1/PUBLISH-LOCK-1-git/CLOSEOUT-HANDOFF-TABLE-1 + v3.75 red-team-audit-method gates + v3.74 DOI-DISCREPANCY-RESOLVE-1 + v3.73 ANTI-TELEGRAPH-1; mirrors kaizen v2.108 + research v2.143 + cloudflare v3.64; 2026-08-28)
