...
Current: **v4.36** (2026-09-19: RE-FALSIFICATION-CLOSED-GATE-1 -- DoD item 9, a closed issue needs a passing re-probe (closes #1013); preserves v4.35 CLOSED-LOOP-DISPOSITION-1 + CMD-TEMPLATE-UPDATE-PLAN-1 + AIGW-MODEL-ID-1 + WORKER-BUILD-GATE-1 + CONFLICT-MARKER-GATE-1 + INFRA-CACHE-STALENESS-1 + DOD-AUDIT-DISCIPLINE-1; preserves v4.30 DEPLOY-GUARD-BYPASS-1 + REPO-IS-DEPLOY-SOURCE-1 + RAW-GITHUB-CDN-STALE-1 + REASONING-FLOOR-1 + ADVISOR-FILES-NOT-FIXES-1)
