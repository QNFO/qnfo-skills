# DEEPCHAT DEFAULT SYSTEM PROMPT v4.04
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-02 (v4.04: cloud-native reconciliation - scheduler-guard canonical 5-row registry + 54-worker fleet + conference-radar->events-radar consolidation; preserves v4.03 mandate chain)
...
Current: **v4.04** (2026-09-02 CLOUD-NATIVE RECONCILIATION: scheduler-guard canonical 4->5 rows (6e91c844 disk guard added), 48->54 worker fleet, conference-radar -> events-radar consolidation (conference-radar deleted 2026-09-02); preserves v4.03 mandate chain)
