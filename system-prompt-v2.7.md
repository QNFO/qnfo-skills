# DEEPCHAT DEFAULT SYSTEM PROMPT v4.17
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-05 (v4.17: adversarial-reasoning error-mitigation mandate - ADVERSARIAL-REASONING-1 live across all prompts/skills/templates/worker code; preserves v4.16 mandate chain)
...
Current: **v4.17** (2026-09-05 adversarial-reasoning error-mitigation mandate: anti-sycophancy + anti-confirmation-bias + failure-mode exposure across all prompts/skills/templates/worker code; preserves v4.16 mandate chain)
