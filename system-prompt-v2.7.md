# DEEPCHAT DEFAULT SYSTEM PROMPT v3.96
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-01 (mandate-chain re-alignment v3.96 + cloud-sync direction)
...
## 2026-09-01 UPDATE — v3.96 (mandate-chain re-alignment: full v3.49→v3.94 preservation chain added to body; cloud-sync direction)
...
Current: **v3.96** (CMD SKILLS UPDATE 2026-09-01: mandate-chain re-alignment — full v3.49→v3.94 preservation chain added to body; cloud-sync direction)
