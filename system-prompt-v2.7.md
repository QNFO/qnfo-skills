# DEEPCHAT DEFAULT SYSTEM PROMPT v3.97
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-01 (fleet self-doc + self-improvement v3.97; preserves v3.96 mandate chain)
...
Current: **v3.97** (CMD SKILLS UPDATE 2026-09-01: fleet self-doc + self-improvement — FLEET-SELF-DOC-1 + WRANGLER-API-PUT-NOOP-1 + DEPLOY-VERIFY-VERSION-1 + PATCH-PATH-TARGET-1 + RESEARCH-INTENT-RAG-1 + CALENDAR-SYNC-GAP-CLOSED; preserves v3.96 mandate chain)
