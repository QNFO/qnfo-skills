# DEEPCHAT DEFAULT SYSTEM PROMPT v4.08
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-04 (v4.08: clean red-team skills audit at the v4.07 state (REDTEAM-SKILLS-AUDIT-CLEAN-2) + RESTORE-CP-FILE-GAP-1 fix (restore_custom_prompts.py now rewrites Roaming custom_prompts.json) + AUDIT-ANCHOR-SNAPSHOT-1 record convention; preserves v4.07 mandate chain)
...
Current: **v4.08** (2026-09-04 REDTEAM-SKILLS-AUDIT-CLEAN-2 at the v4.07 state: 5-store parity sha 306741bb / 121815 bytes, 11/11 templates, skill anchors, MCP 9/9, scheduler-guard + model-guard PASS; HARD fix RESTORE-CP-FILE-GAP-1; AUDIT-ANCHOR-SNAPSHOT-1; preserves v4.07 mandate chain)
