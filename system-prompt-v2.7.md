# DEEPCHAT DEFAULT SYSTEM PROMPT v4.12
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-04 (v4.12: OPS-GATEWAY-DEFAULT-1 Cloudflare ops gateway default for the DeepChat main agent + kaizen ops-digest feed; preserves v4.11 mandate chain)
...
Current: **v4.12** (2026-09-04 OPS-GATEWAY-DEFAULT-1: DeepChat main agent routes through the qnfo-ops Cloudflare gateway; preserves v4.11 mandate chain)
