# DEEPCHAT DEFAULT SYSTEM PROMPT v4.07
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-03 (v4.07: model-key-guard hourly cadence (QNFO-ModelKey-Guard recreated at every-30-min) + clean red-team skills audit at the v4.06 state; preserves v4.06 mandate chain)
...
Current: **v4.07** (2026-09-03 MODEL-KEY-GUARD-HOURLY-1: QNFO-ModelKey-Guard task recreated at every-30-min cadence after JSON preferredModel re-drifted to v4-pro <3h post-fix; REDTEAM-SKILLS-AUDIT-CLEAN-1 at the v4.06 state (5-store parity 29a54113, 11/11 templates, skill anchors, scheduler-guard PASS); preserves v4.06 mandate chain)
