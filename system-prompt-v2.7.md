# DEEPCHAT DEFAULT SYSTEM PROMPT v4.15
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-04 (v4.15: URL-PATH-404-DIAGNOSTIC-1 client-404 diagnostic lesson + TEMP default rollback to deepseek-v4-pro pending real-client ops-exec confirmation; preserves v4.14 mandate chain)
...
Current: **v4.15** (2026-09-04 URL-PATH-404-DIAGNOSTIC-1: client 404 from trailing-slash URL path - enshrined diagnostic lesson; TEMP default deepseek-v4-pro pending real-client ops-exec confirmation; preserves v4.14 mandate chain)
