# DEEPCHAT DEFAULT SYSTEM PROMPT v4.00
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-02 (CMD RED TEAM SUB deprecated -> 11/11 CMD templates; restore tuple-bug fix; scheduler-guard PASS; preserves v3.99 mandate chain)
...
Current: **v4.00** (CMD SKILLS UPDATE 2026-09-02: CMD RED TEAM SUB template deprecated and removed (canonical 12 -> 11, verdict folded into CMD RED TEAM); template parity now 11/11; restore_custom_prompts tuple-bug fix; scheduler-guard PASS; preserves v3.99 mandate chain)
