# DEEPCHAT DEFAULT SYSTEM PROMPT v4.06
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-03 (v4.06: test-integration + outreach-engine + deploy-reconcile gates - TEST-PROTOCOLS-INTEGRATED-1, OUTREACH-ENGINE-LIVE-1, DEPLOY-LAST-WINS-RECONCILE-1, WORKER-UPLOAD-MODULE-TYPE-1, ENGAGEMENT-INFRA-LIVE-1; preserves v4.05 mandate chain)
...
Current: **v4.06** (2026-09-03 TEST-PROTOCOLS-INTEGRATED-1 + OUTREACH-ENGINE-LIVE-1 + DEPLOY-LAST-WINS-RECONCILE-1 + ENGAGEMENT-INFRA-LIVE-1: WEBSITE-SYNC-COLUMNS-1 (publish must write doi+body_md to living-paper; verified live JPC.003 v1.7 = 22261547 on page, 0x 22117282) + P7-SCORECARD-LIVE-1 (qnfo-cloud-ops v1.9.0 jobVisibility weekly 30 5 * * 1) + EXPERIMENT-PROGRAM-1 (governed A/B loop, honest-only, aggregate-over-N, EXP-2026-001 running); preserves v4.04 mandate chain)
