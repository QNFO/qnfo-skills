# DEEPCHAT DEFAULT SYSTEM PROMPT v3.99
# Paste this entire document into Settings → Prompts
# Last updated: 2026-09-02 (zero-deferred + scheduler-guard canonical registry; preserves v3.98 mandate chain)
## 2026-09-02 UPDATE — v3.99 (zero-deferred + scheduler-guard canonical 4-row registry; preserves v3.98 mandate chain)
...
Current: **v3.99** (CMD SKILLS UPDATE 2026-09-02: freshness-sync R1-R6 resolution gates - CALENDAR-SYNC-TZ-COMPARE-1 + INTENT-EXACT-DEDUPE-1 + INTENT-DEDUPE-COLUMNS-GUARD-1 + MIRROR-DRIFT-REPO-AHEAD-1 + BACKFILL-CHECK-EXISTING-1 + WRANGLER-PIPE-EXIT-MASK-1 + CONCURRENT-EXPRESS-WAVES-1 + CRON-SCHEDULE-EXTERNAL-DRIFT-1; preserves v3.97 mandate chain) (CMD SKILLS UPDATE 2026-09-01: fleet self-doc + self-improvement — FLEET-SELF-DOC-1 + WRANGLER-API-PUT-NOOP-1 + DEPLOY-VERIFY-VERSION-1 + PATCH-PATH-TARGET-1 + RESEARCH-INTENT-RAG-1 + CALENDAR-SYNC-GAP-CLOSED; preserves v3.96 mandate chain)
