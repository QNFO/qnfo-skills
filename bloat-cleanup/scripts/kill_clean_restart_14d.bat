@echo off
:: ============================================================
:: DEEPCHAT AGGRESSIVE 14-DAY PRUNE + RESTART (v2.5)
:: For when you need to dig deeper than the default 7-day.
:: ============================================================
...
echo.
echo ============================================================
echo   DEEPCHAT AGGRESSIVE 14-DAY PRUNE v2.5
echo   %date% %time%
echo ============================================================
echo.
...
:: [2/6] Aggressive prune (14-day cutoff + VACUUM)
echo [2/6] Aggressive 14-day prune + VACUUM...
python "%SKILL_DIR%\scripts\agent_db_prune.py" --vacuum --max-age-days 14
