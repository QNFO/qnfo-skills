...
> **v2.15 UPDATE (2026-09-04, kaizen - CMD SKILLS UPDATE: evidence-transfer gates - EXEC-STDOUT-12K-CAP-1 (verify lengths; a truncated download is not complete) + READ-TOOL-PREFIX-ALL-1 (read tool prefixes ALL files; never exact-content transfers via read) + FTS5-DIGIT-TOKEN-PROBE-1 + TASK-DOD-REGISTER-SHAPE-1 (register INSERT omits id, supplies source_table/source_row_id); mirrors system-prompt v4.10 + kaizen v2.133; preserves v2.14):**
...
# DeepChat System Instructions — v2.15 (UIA v0.4 cross-reference + synthesis paper 21901983)
