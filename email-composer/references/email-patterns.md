...
Loaded on demand for specific communication scenarios.

## Pattern 1: Declining an Opportunity While Preserving the Relationship
...
## Pattern 4: Responding to a Cold Outreach

**When to use:** Someone you don't know reaches out about an opportunity.
...
- Asking vague questions ("tell me more") that invite a long pitch
- Committing to anything in the first exchange

## General Tone Guidelines (QNFO/QWAV Voice)

| Principle | Do | Don't |
|-----------|----|----- |
| **Research Integrity** | Cite specific DOIs, use certainty labels | Use superlatives, make unverifiable claims |
| **Directness** | State your position clearly | Hedge, use "I think" / "maybe" / "perhaps" |
| **Honesty** | State limitations, acknowledge gaps | Pretend capabilities you don't have |
| **Brevity** | One clear point per paragraph | Wall of text, multiple asks in one email |
| **Professional warmth** | "Thank you," "I appreciate," "I value" | Cold, transactional language |
| **No jargon** | Explain QWAV in plain terms | "Adelic," "ultrametric," "p-adic" without context |
| **No promissory language** | "We are developing" | "QWAV will revolutionize" |
