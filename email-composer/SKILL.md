...
2. **Retry 2:** Pull from Cloudflare R2: `npx wrangler r2 object get 
   prompts/skills/<name>/SKILL.md --remote --file=_skill.md`
...
*email-composer v2.1 — QNFO custom skill. Load via read('R2 `prompts/skills/email-composer\\SKILL.md'). Not accessible via skill_view().*

> **Version:** (Kaizen-audited 2026-07-15)

## OUTREACH-REVIEW-1 (autonomous meta-update 2026-09-01, change f595172f)

Initial outreach emails are sent fully autonomously with no user review, and only inbound replies requiring a human are routed to the user while all others are drafted and sent on the user's behalf.

- Evidence: user directive 2026-09-01 (durable memory mem-R9CDHuREsOWg)
- Confidence: high
- Scope: outreach and email pipelines only
- Source: qnfo-kaizen v0.2.0 meta loop (intent int-meta-outreach-review-2). Additive-only; no version bump. Git push: deferred to local skill_sync bridge.
