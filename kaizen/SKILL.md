...
> **v2.124 UPDATE (2026-09-02, kaizen — CMD SKILLS UPDATE: zero-deferred + scheduler-guard mirror rows - NO-DEFERRED-ZERO-1 + SCHEDULER-GUARD-1 + CLOUD-FRONTEND-ONLY-1 + AGENTDB-CHUNKED-BACKUP-1; mirrors system-prompt v3.99; preserves v2.123):**
...
> Cross-reference: system-prompt v3.55, research v2.124, cloudflare v3.57, qnfo-core v1.33, session this.
