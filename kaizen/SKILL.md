...
Current: **v2.156** (2026-09-26 CMD UPDATE (HOLISTIC): AI-GW-COST-UNIT-CENTS-1 + CRON-RECONCILE-CONVERGE-1 + SCHEDULES-PUT-ARRAY-1 + REGISTRY-VERSION-LIVE-PRIMARY-1 + DEPLOY-LOCK-EPOCH-TYPE-1 + fleet catch-up remediation (registry drift 0; cron drift 11/11 cleared); mirrors system-prompt v4.40; preserves v2.155)
