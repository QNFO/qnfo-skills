...
Current: **v2.153** (2026-09-19 CMD SKILLS UPDATE: CMD-TEMPLATE-UPDATE-PLAN-1 + AIGW-MODEL-ID-1 + WORKER-BUILD-GATE-1 + CONFLICT-MARKER-GATE-1 + INFRA-CACHE-STALENESS-1 + KAIZEN-ANCHOR-SKEW-1 reconciliation; mirrors system-prompt v4.31; preserves v2.150)
