...
Current: **v2.129** (website-sync columns + P7 scorecard live + Experimentation Program mirror rows: WEBSITE-SYNC-COLUMNS-1 + P7-SCORECARD-LIVE-1 + EXPERIMENT-PROGRAM-1; mirrors system-prompt v4.05; preserves v2.127) (zero-deferred + scheduler-guard canonical registry mirror rows: NO-DEFERRED-ZERO-1 + SCHEDULER-GUARD-1 + CLOUD-FRONTEND-ONLY-1 + AGENTDB-CHUNKED-BACKUP-1; mirrors system-prompt v3.99; preserves v2.123) (freshness-sync R1-R6 resolution mirror rows: CALENDAR-SYNC-TZ-COMPARE-1 + INTENT-EXACT-DEDUPE-1 + INTENT-DEDUPE-COLUMNS-GUARD-1 + MIRROR-DRIFT-REPO-AHEAD-1 + BACKFILL-CHECK-EXISTING-1 + WRANGLER-PIPE-EXIT-MASK-1 + CONCURRENT-EXPRESS-WAVES-1 + CRON-SCHEDULE-EXTERNAL-DRIFT-1; mirrors system-prompt v3.98; preserves v2.122) (fleet self-doc + self-improvement mirror rows: FLEET-SELF-DOC-1 + WRANGLER-API-PUT-NOOP-1 + PATCH-PATH-TARGET-1 + DEPLOY-VERIFY-VERSION-1 + RESEARCH-INTENT-RAG-1 + CALENDAR-SYNC-GAP-CLOSED; mirrors system-prompt v3.97; preserves v2.121) (OPS.007 mandate-chain re-alignment of system-prompt v3.96 + CLOUD-CRON-VERIFY-1; mirrors system-prompt v3.96; preserves v2.120) (run_code heartbeat + child frozen-view mirror rows: RUNCODE-HEARTBEAT-1 + CHILD-FROZEN-VIEW-1 + SECRET-SET-ENDPOINT-1 + CORPUS-ATTRIBUTION-1 + READ-TOOL-PATH-PREFIX-1 + TAPE-SEARCH-HEARTBEAT-1 + CONCURRENT-WORKER-VERIFY-1 + SKILL-PATH-READ-GUARD-1; mirrors system-prompt v3.4; preserves v2.118) (persona-strip + real-client source + prompt-dependent auto mirror rows: PERSONA-STRIP-1 + AUTO-PROMPT-ENSEMBLE-1 + NO-MORE-SKILLS-1 + SOURCE-TAG-REAL-CLIENT-1 + ENSEMBLE-TIMEOUTS-1 + RAG-DATA-ONLY-BOUNDARY-1 + ENSEMBLE-EMPTY-RETRY-1; mirrors system-prompt v3.3; preserves v2.117) (edge idea-intake pipeline + JPCUB research program mirror rows: ENSEMBLE-AUTO-EXPRESS-LIVE-1 + INTENT-TOKEN-ROTATION-1 + ROUTER-CONTEXT-GAP-1 + JPCUB-BENCHMARK-PROGRAM-1 + QNFO-MODEL-ROSTER-2026-1; MODEL-KEY-FILE-DRIFT-1 reset; mirrors system-prompt v3.2; preserves v2.116) (DeepChat toolchain refactor mirror rows: MCP-AUTOAPPROVE-PARITY-1 + FROZEN-VIEW-FALLBACK-1 + CLAIM-SHEET-README-1 + AGENT-MODEL-1 + CF-ROUTER-ALIGN-1 + GIT-REBASE-OURS-TRAP-1 + CANONICAL-SET-CORRECTION-1 (supersedes PROMPT-CANONICAL-9-1); mirrors system-prompt v3.1; preserves v2.115 CONFIG-GUARD-1 gates; preserved v2.114 mirror rows) (mirror rows for the six v3.94 gates; canonical RES.032 v0.2 newversion; preserves v2.113 D1-WRITE-ASCII-1) (D1-WRITE-ASCII-1 + EXEC-AUTOBG-SESSION-ERROR-1 + GIT-REBASE-AFTER-COMMIT-1 + FRAMEWORK-DOGFOOD-1 + REDTEAM-CHILD-CROSS-CHECK-1; canonical DPRF QNFO.RES.032 P0.1 2026-08-29; preserves v2.112 UIA-REPOINT-V04) (UIA-REPOINT-V04 mirror rows + §H v0.4 update (termination condition, frontmatter drift fix); mirrors system-prompt v3.92 + research v2.144; 2026-08-29) (model-key DB root-source + D1 Bearer fallback mirror rows; mirrors system-prompt v3.91 + cloudflare v3.67 + qnfo-core v1.36 + research v2.143 unchanged; 2026-08-28) (weekly-review triage gates mirror rows: GRAPH-SYNC-BULK-ONLY-1 + CONSOLIDATION-TARGET-AUDIT-1 + REGISTRY-LAG-PARITY-1 + ENUMERATION-DRIFT-SNAPSHOT-1; mirrors system-prompt v3.90 + cloudflare v3.66 + qnfo-core v1.36 + research v2.143 unchanged; 2026-08-28) (mirror rows for the QNFO Router endpoint anti-generic + worker deploy-revert discipline; mirrors system-prompt v3.89 + cloudflare v3.65 + qnfo-core v1.36 + research v2.143 unchanged; 2026-08-28)
