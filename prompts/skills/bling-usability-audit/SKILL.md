...
3. **Templates deprecated (v2026-07-11)** — BLING-USABILITY-AUDIT format is inline below. Skip template loading; use inline audit format.
...
# 1.1 BLING audit format (template deprecated v2026-07-11 — use inline format):
# Project: <project>
# Component: <component>
# See bling-usability-audit skill §5 for full inline audit format.
