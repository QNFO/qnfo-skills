...
For sending email, construct email content directly using the Python scripts below. (EMAIL-AGENT template deprecated v2026-07-11 — use inline script execution below.)
...
### Send Email
Construct email parameters directly (to, subject, body, cc, bcc, attachments) then execute the script (EMAIL-AGENT template deprecated):
```powershell
