...
MODEL_DICT = {"providerId": "QNFO-OPS", "modelId": "ops-frontier"}  # GUARD-TRIPLICATE-CONSISTENCY-1 (2026-09-18): canonical default = ops-frontier (aligns model_guard.py DESIRED_KEY + ops-settings-guard.py DESIRED_KEYS)
